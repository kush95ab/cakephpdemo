        ...
        <div class="columns large-12">
            ...
            <div class="text-center">
                <ul>
                    ...
                    <span><?= $this->Html->link("Sign in", ['action' => '../users/login']) ?></span>|   |
                        <span><?= $this->Html->link("Sign up here ", ['action' => '../users/add']) ?></span>|   |  
                        <span><?= $this->Html->link("Articles ", ['action' => '../articles']) ?></span>|   | 
                        <span><?= $this->Html->link("Sessions ", ['action' => '../sessions']) ?></span>
